...
privileged aspect WniosekZmianyImieniaINazwiskaDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    UzytkownikDataOnDemand WniosekZmianyImieniaINazwiskaDataOnDemand.uzytkownikDataOnDemand;
    
    @Autowired
    WniosekZmianyImieniaINazwiskaService WniosekZmianyImieniaINazwiskaDataOnDemand.wniosekZmianyImieniaINazwiskaService;
    ...
    public void WniosekZmianyImieniaINazwiskaDataOnDemand.setUzytkownik(WniosekZmianyImieniaINazwiska obj, int index) {
    ...
    public void WniosekZmianyImieniaINazwiskaDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = wniosekZmianyImieniaINazwiskaService.findWniosekZmianyImieniaINazwiskaEntries(from, to);
        if (data == null) {
