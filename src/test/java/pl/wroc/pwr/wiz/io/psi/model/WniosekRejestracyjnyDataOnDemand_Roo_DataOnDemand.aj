...
privileged aspect WniosekRejestracyjnyDataOnDemand_Roo_DataOnDemand {
    ...
    public void WniosekRejestracyjnyDataOnDemand.setDataZalozenia(WniosekRejestracyjny obj, int index) {
        Date dataZalozenia = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setDataZalozenia(dataZalozenia);
    }
    ...
    public void WniosekRejestracyjnyDataOnDemand.setHaslo(WniosekRejestracyjny obj, int index) {
    ...
    public void WniosekRejestracyjnyDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = WniosekRejestracyjny.findWniosekRejestracyjnyEntries(from, to);
        if (data == null) {
