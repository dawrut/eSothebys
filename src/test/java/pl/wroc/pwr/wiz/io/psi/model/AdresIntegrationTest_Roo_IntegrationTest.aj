...
privileged aspect AdresIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    AdresService AdresIntegrationTest.adresService;
    
    @Test
    public void AdresIntegrationTest.testCountAllAdreses() {
        Assert.assertNotNull("Data on demand for 'Adres' failed to initialize correctly", dod.getRandomAdres());
        long count = adresService.countAllAdreses();
    ...
    public void AdresIntegrationTest.testFindAllAdreses() {
        ...
        List<Adres> result = adresService.findAllAdreses();
    ...
    public void AdresIntegrationTest.testFindAdresEntries() {
        ...
        List<Adres> result = adresService.findAdresEntries(firstResult, maxResults);
    ...
    @Test
    public void AdresIntegrationTest.testUpdateAdresUpdate() {
        Adres obj = dod.getRandomAdres();
        Assert.assertNotNull("Data on demand for 'Adres' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Adres' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyAdres(obj);
        Integer currentVersion = obj.getVersion();
        Adres merged = adresService.updateAdres(obj);
        obj.flush();
    ...
    @Test
    public void AdresIntegrationTest.testSaveAdres() {
        Assert.assertNotNull("Data on demand for 'Adres' failed to initialize correctly", dod.getRandomAdres());
    ...
    @Test
    public void AdresIntegrationTest.testDeleteAdres() {
        Adres obj = dod.getRandomAdres();
        Assert.assertNotNull("Data on demand for 'Adres' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Adres' failed to provide an identifier", id);
        obj = adresService.findAdres(id);
        adresService.deleteAdres(obj);
        obj.flush();
        Assert.assertNull("Failed to remove 'Adres' with identifier '" + id + "'", adresService.findAdres(id));
    }
