...
privileged aspect UzytkownikIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    UzytkownikService UzytkownikIntegrationTest.uzytkownikService;
    
    @Test
    public void UzytkownikIntegrationTest.testCountAllUzytkowniks() {
        Assert.assertNotNull("Data on demand for 'Uzytkownik' failed to initialize correctly", dod.getRandomUzytkownik());
        long count = uzytkownikService.countAllUzytkowniks();
    ...
    public void UzytkownikIntegrationTest.testFindUzytkownik() {
        ...
        obj = uzytkownikService.findUzytkownik(id);
    ...
    public void UzytkownikIntegrationTest.testFindAllUzytkowniks() {
        ...
        List<Uzytkownik> result = uzytkownikService.findAllUzytkowniks();
    ...
    public void UzytkownikIntegrationTest.testFindUzytkownikEntries() {
        ...
        List<Uzytkownik> result = uzytkownikService.findUzytkownikEntries(firstResult, maxResults);
    ...
    @Test
    public void UzytkownikIntegrationTest.testUpdateUzytkownikUpdate() {
        Uzytkownik obj = dod.getRandomUzytkownik();
        Assert.assertNotNull("Data on demand for 'Uzytkownik' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Uzytkownik' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyUzytkownik(obj);
        Integer currentVersion = obj.getVersion();
        Uzytkownik merged = uzytkownikService.updateUzytkownik(obj);
        obj.flush();
    ...
    @Test
    public void UzytkownikIntegrationTest.testSaveUzytkownik() {
        Assert.assertNotNull("Data on demand for 'Uzytkownik' failed to initialize correctly", dod.getRandomUzytkownik());
    ...
    @Test
    public void UzytkownikIntegrationTest.testDeleteUzytkownik() {
        Uzytkownik obj = dod.getRandomUzytkownik();
        Assert.assertNotNull("Data on demand for 'Uzytkownik' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Uzytkownik' failed to provide an identifier", id);
        obj = uzytkownikService.findUzytkownik(id);
        uzytkownikService.deleteUzytkownik(obj);
        obj.flush();
        Assert.assertNull("Failed to remove 'Uzytkownik' with identifier '" + id + "'", uzytkownikService.findUzytkownik(id));
    }
